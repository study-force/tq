...
5. 각 슬롯은 반드시 2~3문단, 250~350자 범위로 작성 (공백 포함 기준). 이 범위를 벗어나면 안 됨 — 너무 짧거나 너무 긴 답변 모두 금지
...
## 슬롯별 작성 기준
슬롯①: 강점 먼저 → 현실 대비 → 가능성 (250~350자, 2~3문단)
슬롯②: causal_paths 인과 서사 + 체크리스트 기반 현상 해석 포함 (250~350자, 2~3문단)
슬롯③: 긴급도 비례 경각심 + 학제 전환 리스크 (250~350자, 2~3문단)
슬롯④: 처방 우선순위 서술 + 솔루션 연결 + 희망 마무리 (250~350자, 2~3문단)
...
- 각 슬롯의 전체 길이는 공백 포함 250~350자 범위를 반드시 지킬 것
- 큰따옴표 포함 시 \\" 이스케이프
